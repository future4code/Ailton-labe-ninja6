  ...
  render() {
    return (
      <Container>
        ...
        <ContainerDev>
            <p>Desenvolvedores:</p>
            <DevsLine><Devs><p>André Luiz</p></Devs><DevsMedia><img src = {Github}/> <img src = {Linkedin}/></DevsMedia></DevsLine>
            <DevsLine><Devs><p>Daniel Melo</p></Devs><DevsMedia><img src = {Github}/> <img src = {Linkedin}/></DevsMedia></DevsLine>
            <DevsLine><Devs><p>Gabriel Theodoro</p></Devs><DevsMedia><img src = {Github}/> <img src = {Linkedin}/></DevsMedia></DevsLine>
        </ContainerDev>
        <ContainerDev>
            <DevsLine><Devs><p>Júlia Muniz</p></Devs><DevsMedia><img src = {Github}/> <img src = {Linkedin}/></DevsMedia></DevsLine>
            <DevsLine><Devs><p>João Zang</p></Devs><DevsMedia><img src = {Github}/> <img src = {Linkedin}/></DevsMedia></DevsLine>
        </ContainerDev>
        <ContainerMedia>
            <img src = {Whats} />
            <img src = {Facebook} />

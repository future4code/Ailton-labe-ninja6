  ...
  changeScreen = () => {
    switch (this.state.actualScreen) {
      ...
      case "jobRegister":
        return <JobRegister />;
      case "jobList":
        return <JobList carrinho={this.state.carrinho} addServices={this.addServices} removeService={this.removeService} goTo={this.goTo} />;
      case "shopCart":
        return <ShopCart carrinho={this.state.carrinho} removeService={this.removeService}/>;
    }
  };
